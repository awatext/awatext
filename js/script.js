const data = [
  { group: '关于我们', items: [
    ...
    {title:'Hack Chat',url:'https://hack.chat/?lounge',desc:'?lounge',tags:['问答','社区', 'HC']},
  ]},
  { group: '阿瓦兰系列', items: [
  ...
  { group: 'HC系列', items: [
    {title:'LOOKUP',url:'https://lookup.awaland.dpdns.org',desc:'查询历史记录',tags:['历史', '工具', 'HC']},
    {title:'HC客户端',url:'https://hc.awaland.dpdns.org',desc:'部署hc++源码',tags:['工具', 'HC']},
  ]},
  { group: '其他项目', items: [
